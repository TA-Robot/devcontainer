...
**次に行うのはP2の実案件に基づく別候補の選定と、課題・評価器・全予算の固定。**
...
| P2（継続）: 課題と評価器を固定 | 第一候補の監査・棄却を完了。実案件の別候補を選び、その後に別familyの小規模を選ぶ | 対象source・利用要求・oracle識別能力・規模条件・全上限が未確定なら開始しない |
...
P2第一候補は11項目の監査で棄却した。次は実際に必要なprojectと変更要求から別候補を選ぶ。
