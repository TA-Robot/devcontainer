"""Content-free accounting for the pinned 0.153.0 native rollout format.
...
def collect(folder, database):
    ...
    try:
        ...
        if any(t['cli_version'] != '0.153.0' or t['model'] != 'gpt-6-astra'
