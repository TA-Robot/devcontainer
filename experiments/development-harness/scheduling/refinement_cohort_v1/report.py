...
def summarize(result, inputs):
    ...
    comparisons = {}
    for candidate, baseline in (('refined', 'standard'), ('refined', 'solo'), ('standard', 'solo')):
    ...
    return {'kind': 'refinement-cohort-quality-v1', 'status': 'measured', 'input_seal': inputs,
            'scope': 'selected-artifact quality at common development wall-clock; one run per condition',
