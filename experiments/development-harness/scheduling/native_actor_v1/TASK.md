# Online scheduling development contract
...
Your run prompt specifies whether native collaboration is available.
...
Your run prompt supplies the finite development and total participant budgets.
Time includes experiments, selection, coordination and the final response. You may
finish early. Public and external scenario limits are 90 seconds, with 5 seconds
per response. A clean final turn and recoverable usage for every participant are
required. Stop or finish every child before your final response. Full evaluation
can take several minutes for complex policies; budget for selection and finalization.
