...
When structured output is requested, finish all tool work and checks before emitting exactly one final result object; never use a result object for progress.
