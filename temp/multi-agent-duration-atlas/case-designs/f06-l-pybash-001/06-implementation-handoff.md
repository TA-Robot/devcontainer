# F06-L-PYBASH-001: implementation handoff

## Exclusive implementation scope

- recipe module: `scripts/agent_duration_cases/f06.py`
- catalog fragment: `experiments/multi-agent-duration/catalog/families/f06.json`
- capsule: `experiments/multi-agent-duration/capsules/f06-l-lease-lifecycle-tests.md`
- focused test: `scripts/test-agent-duration-case-f06.py`
