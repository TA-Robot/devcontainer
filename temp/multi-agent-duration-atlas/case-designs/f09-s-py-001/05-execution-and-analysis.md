# F09-S-PY-001: execution and analysis plan
...
- C0 only; one local data-flow exploit is the intended surface.
...
- Time to concrete exploit versus prose finding.
- Whether deeper effort avoids unreachable exploit claims.
- How often agents test the validator alone instead of the caller boundary.
