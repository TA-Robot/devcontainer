# F05-S-PY-001: task and artifact contract

## Agent-visible task

Refactor duplicate event-name normalization into one private helper without changing any public behavior, signatures, exception type/order, or output. Add focused tests only if needed.

## Required result

- One private helper is used by both public functions.
- All frozen input/output/exception traces match baseline.
- No new public symbol or dependency is introduced.
