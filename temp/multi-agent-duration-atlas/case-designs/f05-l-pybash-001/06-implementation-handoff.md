# F05-L-PYBASH-001: implementation handoff

## Exclusive implementation scope

- recipe module: `scripts/agent_duration_cases/f05.py`
- catalog fragment: `experiments/multi-agent-duration/catalog/families/f05.json`
- capsule: `experiments/multi-agent-duration/capsules/f05-l-backend-schema-migration.md`
- focused test: `scripts/test-agent-duration-case-f05.py`
