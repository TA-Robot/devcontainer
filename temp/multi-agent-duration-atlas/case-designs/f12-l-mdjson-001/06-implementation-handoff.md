# F12-L-MDJSON-001: implementation handoff

## Exclusive implementation scope

- recipe module: `scripts/agent_duration_cases/f12.py`
- catalog fragment: `experiments/multi-agent-duration/catalog/families/f12.json`
- capsule: `experiments/multi-agent-duration/capsules/f12-l-fabric-decision-record.md`
- focused test: `scripts/test-agent-duration-case-f12.py`
...
- recipeは`case_id/recipe_revision/files/hidden/good/valid_alternatives/executable`の共通interfaceを満たし、stdlibだけで構成する。
...
6. D→B known-goodと、異なるidentifierを持つD→A valid alternativeがともにfull-passする。
