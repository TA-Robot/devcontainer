...
6. D→B known-good and the distinct D→A valid alternative both full-pass, and evaluator-required artifact shapes/editable surfaces are recoverable from visible contract/templates.
