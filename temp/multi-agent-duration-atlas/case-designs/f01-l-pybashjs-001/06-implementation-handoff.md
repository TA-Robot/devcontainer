# F01-L-PYBASHJS-001: implementation handoff

## Exclusive implementation scope

- recipe module: `scripts/agent_duration_cases/f01.py`
- catalog fragment: `experiments/multi-agent-duration/catalog/families/f01.json`
- capsule: `experiments/multi-agent-duration/capsules/f01-l-devcontainer-companion-trace.md`
- focused test: `scripts/test-agent-duration-case-f01.py`
