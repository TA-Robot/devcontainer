# F11-M-BASH-001: execution and analysis plan
...
- C1 may delegate lifecycle reproduction while primary owns patch/invariants.
- CV injects install failures and restart cuts.
- CS stages reproduction, repair, fault verification, and recovery documentation.
...
- How much time is lifecycle reproduction versus Bash editing?
- Does verifier fault injection expose false-ready states?
- Which depth avoids overbroad normalization/deletion?
