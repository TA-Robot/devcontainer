# F04-M-PY-001: implementation handoff
...
- capsule: `experiments/multi-agent-duration/capsules/f04-m-python-state-cli.md`
...
- Retain the existing medium recipe and recorded case revision.
- Refactor broad evaluator outcomes into criterion evidence only through a new evaluator revision with explicit compatibility notes.
- Add live measurement coverage; the current corpus has no valid M provider run.
