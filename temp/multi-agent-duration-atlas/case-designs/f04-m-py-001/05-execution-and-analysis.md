# F04-M-PY-001: execution and analysis plan
...
- C1 can delegate tests/document contract review while primary owns store/CLI integration.
- CV can verify atomicity and error-state integrity after implementation.
...
- How much time is editing versus filesystem validation?
- Does delegation save wall time or add doc/test synthesis tail?
- Which hidden subcriterion distinguishes shallow partial patches?
