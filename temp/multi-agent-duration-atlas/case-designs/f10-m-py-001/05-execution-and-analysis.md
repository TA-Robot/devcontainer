# F10-M-PY-001: execution and analysis plan
...
- C1 may delegate instrumentation implementation while primary designs blocks/interprets results.
- CC compares independent bottleneck hypotheses against the same raw observations.
- CV checks counter consistency and reruns blocks in rotated order.
...
- case timeout safety cap: 80 minutes
...
- Does delegation reduce instrumentation critical path?
- How often do agents pool cold/warm conditions incorrectly?
- Which depth distinguishes conditional bottlenecks from a single winner?
- How much verifier rerun time changes the conclusion?
