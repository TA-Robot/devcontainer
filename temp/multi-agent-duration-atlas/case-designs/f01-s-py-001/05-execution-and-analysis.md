# F01-S-PY-001: execution and analysis plan
...
- C0 is the baseline because the chain is serial and local.
- A consult/delegate run is intentionally ineligible: dispatch overhead has no natural independent subtask.
...
- How much time is repository discovery versus artifact encoding?
- Does deeper effort reduce skipped validation edges or only add latency?
- Do false distractor hops correlate with shorter runs?
