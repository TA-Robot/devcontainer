# F04-S-PY-001: execution and analysis plan
...
- C0 only because the change is a single local reasoning/edit unit.
...
- Provider/tool startup share of total time.
- Whether deeper settings add latency without criterion gain.
- Failure mode distribution across the four edge contracts.
