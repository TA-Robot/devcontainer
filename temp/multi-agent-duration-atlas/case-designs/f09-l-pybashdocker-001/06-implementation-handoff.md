# F09-L-PYBASHDOCKER-001: implementation handoff

## Exclusive implementation scope

- recipe module: `scripts/agent_duration_cases/f09.py`
- catalog fragment: `experiments/multi-agent-duration/catalog/families/f09.json`
- capsule: `experiments/multi-agent-duration/capsules/f09-l-worktree-container-threat-model.md`
- focused test: `scripts/test-agent-duration-case-f09.py`
