# F09-L-PYBASHDOCKER-001: execution and analysis plan
...
- CP can shard worktree, Docker, credential, and cleanup threats after a shared asset/boundary model; primary owns composed risk.
- CC compares independent threat models for anchoring-resistant coverage.
- CV executes attacks and attempts control bypasses.
- CD continues only for disputed claims with runnable attack/control evidence.
- CS stages topology, threat discovery, control design, adversarial verification, and revision.
...
- Which threat shard dominates discovery and validation time?
- Does independent modeling increase attack/control coverage enough to offset synthesis?
- Which dialogue exchanges produce new exploits or controls?
- How do max/ultra affect unknown honesty and composed control reasoning?
