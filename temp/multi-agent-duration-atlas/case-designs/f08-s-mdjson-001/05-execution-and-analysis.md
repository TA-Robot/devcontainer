# F08-S-MDJSON-001: execution and analysis plan
...
- CC may produce two independent option analyses before primary comparison; independence prevents early anchoring.
- CD is eligible only for a concrete disputed constraint/counterexample, stopping when evidence resolves it.
...
- Does independent analysis surface both counterexamples faster?
- Which depth first preserves explicit unknowns?
- Does dialogue add new evidence or restate preferences?
