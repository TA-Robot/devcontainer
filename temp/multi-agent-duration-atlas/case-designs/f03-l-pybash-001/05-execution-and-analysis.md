# F03-L-PYBASH-001: execution and analysis plan
...
- C1 may delegate deterministic reproducer construction while primary owns root-cause synthesis.
- CC can compare independent reproducer strategies, scored for determinism and cleanup.
- CV reruns the harness and attempts counterexample timing without gold.
- CD is eligible only while a concrete disagreement about ordering or semantics can be tested.
...
- case timeout safety cap: 110 minutes
...
- How long until the first deterministic reproduction?
- Does candidate comparison avoid flaky sleep-based solutions?
- How much verifier time is needed to expose nondeterminism?
- Which depth handles exactly-once caveats correctly?
