# F03-L-PYBASH-001: implementation handoff

## Exclusive implementation scope

- recipe module: `scripts/agent_duration_cases/f03.py`
- catalog fragment: `experiments/multi-agent-duration/catalog/families/f03.json`
- capsule: `experiments/multi-agent-duration/capsules/f03-l-crash-restart-diagnosis.md`
- focused test: `scripts/test-agent-duration-case-f03.py`
