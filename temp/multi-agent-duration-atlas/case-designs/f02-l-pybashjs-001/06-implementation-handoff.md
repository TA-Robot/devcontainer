# F02-L-PYBASHJS-001: implementation handoff

## Exclusive implementation scope

- recipe module: `scripts/agent_duration_cases/f02.py`
- catalog fragment: `experiments/multi-agent-duration/catalog/families/f02.json`
- capsule: `experiments/multi-agent-duration/capsules/f02-l-hook-lifecycle-review.md`
- focused test: `scripts/test-agent-duration-case-f02.py`
