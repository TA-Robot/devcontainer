# F12-M-MDJSON-001: execution and analysis plan
...
- CP can independently map claim provenance and execute evidence replay before primary adjudication.
- CC compares independent adjudications for anchoring resistance.
- CV checks entailment and reruns decisive evidence.
- CD is eligible only for disputed claims where another source/test can change disposition.
...
- case timeout safety cap: 45 minutes
...
- Does independent adjudication reduce majority/authority bias?
- How much time is provenance normalization versus evidence replay?
- Which dialogue exchanges add decisive evidence?
- Which depth preserves platform unknowns and narrows severity?
