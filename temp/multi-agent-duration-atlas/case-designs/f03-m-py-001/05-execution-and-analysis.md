# F03-M-PY-001: execution and analysis plan
...
- C1 may delegate reproduction/state inspection while primary owns causal synthesis.
- CV can challenge the root-cause chain with fresh/reload counterexamples.
...
- Does a delegated reproducer arrive before primary diagnosis?
- How much synthesis tail is needed to connect store and scheduler?
- Which effort captures both regression layers?
