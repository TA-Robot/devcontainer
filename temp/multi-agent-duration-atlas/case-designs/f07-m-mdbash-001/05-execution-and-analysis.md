# F07-M-MDBASH-001: execution and analysis plan
...
- C1 may delegate source-of-truth/command inventory while primary writes the ordered runbook.
- CV replays failure branches and audits destructive boundaries.
- CS may stage fact extraction, writing, replay verification, and revision.
...
- How much time is fact discovery versus replay debugging?
- Does verifier replay catch unsafe order missed by writer?
- Does deeper effort preserve evidence on negative branches?
