# F05-M-PY-001: execution and analysis plan
...
- C1 may delegate caller inventory while primary designs and integrates the interface.
- CV can compare old/new behavior and search for missed reflective callers.
- CS may stage inventory, implementation, compatibility verification.
...
- Is caller discovery or patching the dominant time?
- Does staged verification reduce missed reflective imports?
- Which depth captures lifecycle ownership rather than merely changing syntax?
