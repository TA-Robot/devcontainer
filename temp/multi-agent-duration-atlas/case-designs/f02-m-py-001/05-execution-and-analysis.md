# F02-M-PY-001: execution and analysis plan
...
- C1 may delegate exploit reproduction while primary owns full diff review and ranking.
- CC can compare two independent reviews; candidate independence is preserved until common evaluator scoring.
- CV can verify triggers without seeing gold.
...
- Does independent review improve two-defect recall enough to offset comparison tail?
- Does delegation accelerate exploit evidence collection?
- Which setting captures interaction rather than isolated findings?
