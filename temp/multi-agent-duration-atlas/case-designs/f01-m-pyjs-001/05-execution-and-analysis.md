# F01-M-PYJS-001: execution and analysis plan
...
- C0 baseline remains required.
- C1 may delegate the JavaScript consumer half while primary owns synthesis across the JSON contract.
- CP is ineligible because the producer/consumer halves require a shared boundary reconciliation.
...
- Does C1 shorten discovery or merely add synthesis tail?
- Which setting first captures both fail-open branches?
- How much time is spent crossing the language/schema boundary?
