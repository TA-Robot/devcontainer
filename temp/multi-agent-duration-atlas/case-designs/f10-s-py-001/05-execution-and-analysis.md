# F10-S-PY-001: execution and analysis plan
...
- C0 only; the hot path and evidence are local.
...
- Time spent executing measurements versus interpreting them.
- Whether deeper settings avoid absolute-speedup overclaiming.
- How frequently agents chase the visible sort distractor.
