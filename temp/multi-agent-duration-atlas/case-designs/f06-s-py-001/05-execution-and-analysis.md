# F06-S-PY-001: execution and analysis plan
...
- C0 only; the behavior partition is local and serial.
...
- How long does contract partitioning take relative to writing tests?
- Does deeper effort kill more mutants or merely add redundant cases?
- Do agents violate the test-only boundary?
