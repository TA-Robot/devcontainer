# F03-S-PY-001: execution and analysis plan
...
- C0 only; reproduction and root cause are a single local chain.
...
- How much time elapses between test reproduction and final artifact?
- Does deeper effort avoid the nearby conversion distractor?
- Is regression completeness correlated with output length?
