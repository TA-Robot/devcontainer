# F07-L-MDPYBASH-001: implementation handoff

## Exclusive implementation scope

- recipe module: `scripts/agent_duration_cases/f07.py`
- catalog fragment: `experiments/multi-agent-duration/catalog/families/f07.json`
- capsule: `experiments/multi-agent-duration/capsules/f07-l-backend-migration-docs.md`
- focused test: `scripts/test-agent-duration-case-f07.py`
