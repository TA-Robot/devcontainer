# F06-M-PY-001: execution and analysis plan
...
- C1 may delegate contract-to-matrix extraction while primary implements and deduplicates tests.
- CC can compare two test designs by mutation kills and runtime.
- CV runs mutation groups and reports surviving counterexamples.
...
- Do independent designs achieve the same kills with different runtime/complexity?
- Which interaction mutants require deeper reasoning?
- How much verifier time is mutation execution versus feedback?
