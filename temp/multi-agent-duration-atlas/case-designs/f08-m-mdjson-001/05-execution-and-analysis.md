# F08-M-MDJSON-001: execution and analysis plan
...
- CC assigns independent proposals from the same immutable constraints, then primary scores/synthesizes.
- CD exchanges only disputed invariant/transition claims and executable simulator evidence.
- CV attempts hidden failure scenarios without gold.
- CS can stage constraint extraction, proposal, adversarial verification, and revision.
...
- case timeout safety cap: 95 minutes
...
- Do independent proposals increase invariant coverage and at what synthesis cost?
- Which dialogue exchanges add a new passing/failing scenario?
- Does verifier time predict proposal revision quality?
- How does xhigh/max affect unsupported exactly-once claims?
