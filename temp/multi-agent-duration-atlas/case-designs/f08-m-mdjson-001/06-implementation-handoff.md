# F08-M-MDJSON-001: implementation handoff

## Exclusive implementation scope

- recipe module: `scripts/agent_duration_cases/f08.py`
- catalog fragment: `experiments/multi-agent-duration/catalog/families/f08.json`
- capsule: `experiments/multi-agent-duration/capsules/f08-m-job-responsibility-design.md`
- focused test: `scripts/test-agent-duration-case-f08.py`
