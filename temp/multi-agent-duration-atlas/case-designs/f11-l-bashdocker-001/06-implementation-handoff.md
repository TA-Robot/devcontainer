# F11-L-BASHDOCKER-001: implementation handoff

## Exclusive implementation scope

- recipe module: `scripts/agent_duration_cases/f11.py`
- catalog fragment: `experiments/multi-agent-duration/catalog/families/f11.json`
- capsule: `experiments/multi-agent-duration/capsules/f11-l-devcontainer-rebuild-recovery.md`
- focused test: `scripts/test-agent-duration-case-f11.py`
