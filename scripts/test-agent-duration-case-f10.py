...
CATALOG_PATH = ROOT / "experiments" / "multi-agent-duration" / "catalog" / "families" / "f10.json"
...
class F10PerformanceResourceCaseTests(unittest.TestCase):
    ...
    def test_snapshots_are_reproducible_at_fixed_time(self) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="duration-f10-repro-") as raw:
            root = Path(raw)
