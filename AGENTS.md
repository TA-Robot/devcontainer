...
設計の正本は`docs/agents/collaboration-model.md`、自動観測contractは`docs/agents/collaboration-observation.md`、target project向け手順は`project/docs/agents/collaboration-playbook.md`を参照してください。
